...
const MessagesContainer = () => {
          ...
          <div className="flex items-center justify-start gap-3">
            <Avatar className="h-8 w-8 rounded-full overflow-hidden">
              {message.sender.image && (
                <AvatarImage
                  src={`http://localhost:8747/${message.sender.image}`}
                  alt="profile"
  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-hide p-4 px-8 md:w-[65vw] ld:w-[70vw] xl:w-[80vw] w-full">
      {handleMessages()}
      <div className="" ref={scrollRef} />
      {showImage && (
        <div className="fixed z-[1000] left-0 top-0 h-[100vh] w-[100vw] flex items-center justify-center backdrop-blur-lg flex-col">
          <div>
            <img
